 ...
 *
 * Two writers need this and neither may need the whole file: the sweep, which
 * stands in for the stdin a hook would have had, and `SubagentStop`, which
...
export function parentTranscriptBeside(agentTranscriptPath, sessionId) {
  ...
  if (path.basename(subagentsDir) !== SUBAGENTS_FOLDER || path.basename(sessionDir) !== sessionId) return '';
